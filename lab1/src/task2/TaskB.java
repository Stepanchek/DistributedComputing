...
public class TaskB {
    ...
    private static MyRunnableB firstThread;
    private static MyRunnableB secondThread;
    private static void setGUI() {
        ...
        buttonStartFirstThread.addActionListener(e -> {
            ...
            firstThread = new MyRunnableB(slider, -1, semaphore);
            firstThread.start();
        });
        ...
        buttonStartSecondThread.addActionListener(e -> {
            ...
            secondThread  = new MyRunnableB(slider, 1, semaphore);
            secondThread.start();
        });
