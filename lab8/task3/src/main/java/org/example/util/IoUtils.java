...
public final class IoUtils {
    ...
    public static void writePlayer(DataOutputStream out, Book book, boolean withId) throws IOException {
        if (withId) {
    ...
    public static void writeTeam(DataOutputStream out, Author author, boolean withId) throws IOException {
        if (withId) {
